...
public class BillingServiceOldUserIntegrationTest extends TestData {
	...
	public void setUp() throws ParseException {
		...
		User user = new User("KetulOldUser", "CUSTOMER", df.parse("2016-05-05"));
		user.setId(userId);
	...
	public void test_getDiscountByUserAndEligibleAmount_ForAffilliateUser() throws Exception {
		...
		Double eligibleAmount = billingService.getTotalEligibleAmountForDiscount(products);
		Double eligibleDiscount = (eligibleAmount * BillingConstants.oldCustomerDiscountPercent) / 100;
		// when
